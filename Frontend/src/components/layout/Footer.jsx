/**
 * @file Footer.jsx
 * @brief Footer premium minimalista para e-commerce de moda
 */
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="text-xl font-light tracking-[0.15em] uppercase block mb-6">
              Adi Estilos
            </Link>
            <p className="text-neutral-400 text-sm font-light leading-relaxed mb-6">
              Moda que refleja tu esencia. Piezas atemporales diseñadas para el día a día.
            </p>
            {/* Redes sociales */}
      ...
      <div className="border-t border-neutral-800">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-neutral-500">
            <p>© {anioActual} Adi Estilos. Todos los derechos reservados.</p>
            ...
            {/* Métodos de pago (iconos placeholder) */}
            <div className="flex items-center gap-3">
              <span className="text-neutral-600">Métodos de pago:</span>
              <div className="flex gap-2">
                {['Visa', 'MC', 'PSE'].map((method) => (
                  <span 
                    key={method}
                    className="px-2 py-1 bg-neutral-800 text-neutral-400 text-[10px] rounded"
                  >
                    {method}
                  </span>
                ))}
