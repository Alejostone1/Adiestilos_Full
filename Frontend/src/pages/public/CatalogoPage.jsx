...
const CatalogoPage = () => {
  useSeo({
    title: 'Tienda | Adi Estilos - Ropa en Pereira, Risaralda',
    description: 'Explora toda la ropa de Adi Estilos en Pereira: camisetas, blusas, vestidos y pantalones para mujer y hombre. Envíos a toda Colombia.',
    path: '/tienda',
  });
