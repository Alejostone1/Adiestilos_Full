                    ...
                    <div className="relative z-10 flex flex-col h-full">
                       ...
                       <div className="mt-8 space-y-2 flex-1">
                          ...
                          <div className="flex justify-between items-center text-xs">
                             ...
                             <span className="font-semibold text-primary text-lg">{formatearMoneda(item.totalDevolucion)}</span>
                          </div>
                       </div>
    ...
    return (
      <div className="flex flex-col justify-center items-center h-screen bg-gray-50 dark:bg-gray-950 gap-4">
        ...
        <button 
          ...
          className="px-6 py-2 bg-primary text-white rounded-xl font-semibold hover:bg-tertiary transition-all"
        >
          Volver al buscador
        </button>
      </div>
           ...
           <div className="xl:col-span-2 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 ...
                 <div className="bg-white dark:bg-gray-900 p-8 rounded-[3rem] shadow-xl shadow-gray-200/40 dark:shadow-none border border-gray-100 dark:border-gray-800 relative overflow-hidden group">
                    ...
                    <h3 className="text-[11px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-6 flex items-center gap-2 relative z-10">
                       <FiUser className="text-primary" /> Solicitante
                    </h3>
                    <div className="relative z-10">
                       ...
                       <p className="text-xs text-primary font-semibold mb-8">{devolucion.usuarioCliente?.correoElectronico || 'Sin correo'}</p>
                 ...
                 <div className="bg-white dark:bg-gray-900 p-8 rounded-[3rem] shadow-xl shadow-gray-200/40 dark:shadow-none border border-gray-100 dark:border-gray-800 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                       ...
                       <span className={`inline-block px-3 py-1 rounded-xl text-[11px] font-semibold uppercase tracking-wider mb-8 ${
                          devolucion.tipoDevolucion === 'total' ? 'bg-primary-fixed text-primary' : 'bg-orange-50 text-orange-600'
                       }`}>
              ...
              <div className="bg-white dark:bg-gray-900 p-8 rounded-[3rem] shadow-xl shadow-gray-200/40 dark:shadow-none border border-gray-100 dark:border-gray-800">
                  ...
                  <div className="space-y-6">
                    <div>
                      <span className="text-[11px] font-semibold text-primary uppercase tracking-wide block mb-2">Motivo Principal</span>
                      <p className="text-gray-700 dark:text-gray-300 font-medium bg-primary-fixed dark:bg-tertiary/10 p-5 rounded-3xl border border-primary-fixed dark:border-tertiary/30">
                        {devolucion.motivo}
                      </p>
                    </div>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-[3rem] shadow-xl shadow-gray-200/40 dark:shadow-none border border-gray-100 dark:border-gray-800 overflow-hidden">
                 <div className="p-8 border-b border-gray-100 dark:border-gray-800 bg-gray-50/30 dark:bg-gray-800/20">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-3 uppercase tracking-tight">
                       <FiPackage className="text-primary" /> Items Devueltos
                    </h3>
                 </div>
                  ...
                  <div className="p-8 space-y-4">
                      {devolucion.detalleDevoluciones?.map((item, idx) => {
                         ...
                         return (
                            <div key={idx} className="flex gap-6 p-5 rounded-[2.5rem] bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:border-primary-fixed dark:hover:border-tertiary/40 transition-all items-center group">
                                ...
                                <div className="flex-1 min-w-0">
                                   <div className="flex items-center gap-2 mb-1">
                                      <span className="text-[11px] font-semibold text-primary uppercase tracking-wide">{item.variante?.codigoSku}</span>
                                   ...
                                   <div className="flex gap-2 mt-3">
                                      ...
                                      <span className="text-[11px] font-semibold bg-primary-fixed dark:bg-tertiary/20 px-4 py-1.5 rounded-xl text-primary dark:text-primary uppercase tracking-wide border border-primary-fixed dark:border-tertiary/30">
           ...
           <div className="space-y-8">
              ...
              <div className="bg-white dark:bg-gray-900 p-8 rounded-[3rem] shadow-xl shadow-gray-200/40 dark:shadow-none border border-gray-100 dark:border-gray-800">
                  <h3 className="text-xs font-semibold text-gray-800 dark:text-white uppercase tracking-[0.1em] mb-8 flex items-center gap-3">
                     <FiClock className="text-primary" /> Trazabilidad
                  </h3>
                  <div className="space-y-6">
                     <div className="flex gap-4">
