  ...
  const QuickAction = ({ icon, title, onClick, color }) => (
    ...
    >
      <Space orientation="vertical" align="center" style={{ width: '100%' }}>
        ...
        <Text style={{ fontSize: '13px', fontWeight: 600 }} className="text-slate-700 dark:text-slate-200">{title}</Text>
      </Space>
    </Card>
  );
        ...
        <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <Title level={1} className="m-0 !font-semibold !tracking-tight !text-3xl md:!text-4xl dark:!text-white">
                Dashboard
              </Title>
            </div>
            <Paragraph className="!text-slate-500 dark:!text-slate-400 !text-base md:!text-lg !m-0">
              Bienvenido de nuevo. Aquí tienes un resumen de <span className="font-semibold text-gradient dark:text-blue-400">Adi Estilos</span>.
            </Paragraph>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <button 
              ...
              className="card-3d px-6 py-3 flex items-center gap-2 font-semibold text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-800/60"
            >
              <FilterOutlined />
              Filtros
            </button>
            ...
            <Row gutter={[32, 32]}>
              ...
              <Col xs={24} xl={8}>
                <div className="card-3d h-full p-8 flex flex-col justify-center bg-white dark:bg-slate-800/60">
                  <Title level={4} className="!mb-8 !font-semibold !flex items-center gap-2 dark:!text-white">
                   ...
                   {/* Compact Inventory Status */}
                    <div className="card-3d relative overflow-hidden group flex-1 bg-white dark:bg-slate-800/60">
                      ...
                      <div className="p-7 relative z-10 flex flex-col h-full">
                        <Text className="!text-slate-500 dark:!text-slate-400 !font-semibold !text-[11px] tracking-[0.14em] uppercase block mb-1">Módulo Logístico</Text>
                        <Title level={4} className="!m-0 !font-semibold !mb-6 dark:!text-white">Inventario Global</Title>
                        
                        <div className="grid grid-cols-2 gap-4 mb-6">
                            <Statistic 
                              title={<Text className="!text-slate-400 dark:!text-slate-500 !text-[11px] font-semibold uppercase">SKUs</Text>}
                              value={dashboardData?.resumenInventario?.totalProductos || 0}
                              styles={{ content: { fontWeight: 700, fontSize: '20px', color: 'var(--text-main)' } }}
                            />
                            <Statistic 
                              title={<Text className="!text-blue-500/80 dark:!text-blue-400 !text-[11px] font-semibold uppercase">Valor</Text>}
                              value={dashboardData?.resumenInventario?.valorTotalInventario || 0}
                              styles={{ content: { fontWeight: 700, fontSize: '18px', color: 'var(--accent-primary)' } }}
                        ...
                        <button 
                          ...
                          className="mt-auto w-full py-3 bg-slate-900 dark:bg-blue-600 hover:bg-slate-800 dark:hover:bg-blue-700 text-white rounded-xl font-semibold text-xs flex items-center justify-center gap-2 transition-all"
                        >
                       ...
                       <div className="p-7 relative z-10 flex flex-col h-full">
                          ...
                          <div className="mb-6">
                            <Statistic 
                                ...
                                prefix="$"
                                styles={{ content: { fontWeight: 700, fontSize: '24px', color: 'var(--text-main)' } }}
                            />
                          ...
                          <button 
                            onClick={() => navigate('/admin/ventas-credito')}
                            className="mt-auto w-full py-3 border border-slate-200 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700/50 text-slate-700 dark:text-slate-300 rounded-xl font-semibold text-xs transition-all"
                          >
                            Gestionar Cobros
                          </button>
                       </div>
