      ...
      <div className="p-4 md:p-10 bg-gray-50 dark:bg-gray-950 min-h-screen animate-in fade-in duration-500">
        <div className="max-w-[1200px] mx-auto space-y-12">
           ...
           <div className="text-center space-y-6 py-10">
              <div className="inline-flex p-4 bg-primary text-white rounded-[2rem] shadow-2xl shadow-primary/40 mb-4 animate-bounce">
              ...
              <div className="max-w-2xl mx-auto relative group mt-10">
                 <div className="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none">
                    <FiSearch className="h-6 w-6 text-gray-400 group-focus-within:text-primary transition-colors" />
                 </div>
                 <input 
                   type="text" 
                   value={busqueda}
                   ...
                   className="w-full pl-16 pr-6 py-6 bg-white dark:bg-gray-900 border-none rounded-[2.5rem] shadow-2xl shadow-gray-200/50 dark:shadow-none ring-1 ring-gray-100 dark:ring-gray-800 focus:ring-4 focus:ring-primary/20 text-lg font-semibold transition-all"
                 />
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filtrados.map((item) => (
                 <div 
                    ...
                    className="group bg-white dark:bg-gray-900 p-8 rounded-[3rem] shadow-xl shadow-gray-200/40 dark:shadow-none border border-gray-100 dark:border-gray-800 hover:scale-[1.02] hover:border-primary dark:hover:border-tertiary transition-all cursor-pointer relative overflow-hidden"
                 >
                    <div className="absolute top-0 right-0 w-24 h-24 bg-primary-fixed dark:bg-tertiary/20 rounded-bl-[60px] -mr-8 -mt-8 group-hover:scale-110 transition-transform" />
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                       ...
                       <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800 flex justify-between items-center">
                          ...
                          <FiArrowRight className="h-5 w-5 text-gray-300 group-hover:text-primary group-hover:translate-x-1 transition-all" />
                       </div>
                    </div>
                 </div>
              ))}
      ...
      <div className="max-w-[1400px] mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              ...
              <div>
                 <div className="flex items-center gap-3 mb-1">
                    ...
                    <span className={`px-2.5 py-0.5 rounded-lg text-[11px] font-semibold uppercase tracking-wide border ${
                      ...
                      : 'bg-primary-fixed text-primary border-primary-fixed dark:bg-tertiary/20 dark:border-tertiary'
                    }`}>
                      {credito.estado}
                    </span>
                 </div>
           ...
           {credito.estado === 'activo' && (
             <button 
                ...
                className="flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-primary to-tertiary text-white font-semibold uppercase text-xs tracking-wide rounded-[2rem] shadow-xl shadow-primary/40 hover:scale-105 active:scale-95 transition-all"
             >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
           ...
           <div className="xl:col-span-2 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 ...
                 <div className="bg-white dark:bg-gray-900 p-8 rounded-[3rem] shadow-xl shadow-gray-200/40 dark:shadow-none border border-gray-100 dark:border-gray-800 relative overflow-hidden group">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-primary-fixed dark:bg-tertiary/20 rounded-bl-[100px] -mr-8 -mt-8 transition-transform group-hover:scale-110" />
                    <h3 className="text-[11px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-6 flex items-center gap-2 relative z-10">
                       <FiUser className="text-primary" /> Identificación del Deudor
                    </h3>
                    <div className="relative z-10">
                       ...
                       <p className="text-xs text-primary font-semibold mb-8">{credito.usuarioCliente?.correoElectronico || 'Correo no registrado'}</p>
                 ...
                 <div className="bg-white dark:bg-gray-900 p-8 rounded-[3rem] shadow-xl shadow-gray-200/40 dark:shadow-none border border-gray-100 dark:border-gray-800 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                       ...
                       <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="bg-primary-fixed dark:bg-tertiary/20 p-4 rounded-2xl border border-primary-fixed dark:border-tertiary/30">
                             <p className="text-[11px] font-semibold text-primary uppercase leading-none mb-1">Monto de Deuda</p>
                             <p className="text-sm font-semibold text-primary dark:text-primary">{formatearPrecio(credito.montoTotal)}</p>
                          </div>
                       </div>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-[3rem] shadow-xl shadow-gray-200/40 dark:shadow-none border border-gray-100 dark:border-gray-800 overflow-hidden">
                 <div className="p-8 border-b border-gray-100 dark:border-gray-800 bg-gray-50/30 dark:bg-gray-800/20">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-3 uppercase tracking-tight">
                       <FiShoppingBag className="text-primary" /> Artículos Financiados
                    </h3>
                 </div>
                 ...
                 <div className="p-8 space-y-4 max-h-[500px] overflow-y-auto custom-scrollbar">
                     {credito.venta?.detalleVentas?.map((item) => {
                        ...
                        return (
                           <div key={item.idDetalleVenta} className="flex gap-6 p-5 rounded-[2.5rem] bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:border-primary-fixed dark:hover:border-tertiary/40 transition-all items-center group">
           ...
           <div className="space-y-8">
              ...
              {/* Resumen de Deuda */}
              <div className="bg-white dark:bg-gray-900 p-10 rounded-[4rem] shadow-2xl shadow-primary/10 dark:shadow-none border border-gray-100 dark:border-gray-800 text-center relative overflow-hidden group">
                 <div className="absolute top-0 left-0 w-full h-3 bg-gradient-to-r from-primary via-primary-container to-tertiary" />
              ...
              <div className="bg-white dark:bg-gray-900 p-8 rounded-[3rem] shadow-xl shadow-gray-200/40 dark:shadow-none border border-gray-100 dark:border-gray-800 max-h-[600px] overflow-hidden flex flex-col relative">
                 <h3 className="text-xs font-semibold text-gray-800 dark:text-white uppercase tracking-[0.1em] mb-8 flex items-center gap-3">
                    <FiClock className="text-primary" /> Línea de Tiempo de Pagos
                 </h3>
                    ...
                    {credito.venta?.pagos?.filter(p => p.tipoPago === 'abono' || p.metodoPago?.nombreMetodo.toLowerCase().includes('crédito') === false).map((pago, idx) => (
                       <div key={pago.idPago} className="relative pl-10 group">
                          ...
                          {idx !== (credito.venta?.pagos?.length - 1) && (
                             <div className="absolute left-[11px] top-6 bottom-[-24px] w-0.5 bg-gray-100 dark:bg-gray-800 transition-colors group-hover:bg-primary-fixed" />
                          )}
                          
                          <div className="absolute left-0 top-1 h-6 w-6 rounded-2xl bg-white dark:bg-gray-900 border-2 border-primary flex items-center justify-center text-[11px] font-semibold text-primary z-10 transition-all group-hover:scale-110 group-hover:bg-primary group-hover:text-white">
                             {idx + 1}
                          </div>

                          <div className="bg-gray-50 dark:bg-gray-800/40 p-5 rounded-[2rem] border border-gray-100 dark:border-gray-800 transition-all hover:bg-white dark:hover:bg-gray-900 hover:shadow-xl hover:border-primary-fixed dark:hover:border-tertiary/40">
                             ...
                             {pago.referencia && (
                                <p className="mt-3 text-[11px] font-semibold text-primary uppercase tracking-tighter bg-primary-fixed dark:bg-tertiary/20 px-2 py-1 rounded-lg inline-block">Ref: {pago.referencia}</p>
                             )}
                          </div>
                       </div>
                    ))}
