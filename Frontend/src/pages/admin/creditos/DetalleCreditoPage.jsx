  ...
  if (cargando) {
    return (
      <div className="flex flex-col justify-center items-center h-screen bg-gray-50 dark:bg-gray-950 gap-4">
        ...
        <p className="text-xs font-black text-gray-400 uppercase tracking-widest animate-pulse">Sincronizando Expediente...</p>
      </div>
    );
  }
      ...
      <div className="p-4 md:p-10 bg-gray-50 dark:bg-gray-950 min-h-screen animate-in fade-in duration-500">
        <div className="max-w-[1200px] mx-auto space-y-12">
           ...
           <div className="text-center space-y-6 py-10">
              ...
              <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tight">Consultar Expediente</h1>
              ...
              <div className="max-w-2xl mx-auto relative group mt-10">
                 ...
                 <input 
                   ...
                   className="w-full pl-16 pr-6 py-6 bg-white dark:bg-gray-900 border-none rounded-[2.5rem] shadow-2xl shadow-gray-200/50 dark:shadow-none ring-1 ring-gray-100 dark:ring-gray-800 focus:ring-4 focus:ring-indigo-500/20 text-lg font-bold transition-all"
                 />
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filtrados.map((item) => (
                 ...
                 >
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                       <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-4">Crédito #{item.idCredito}</span>
                       ...
                       <div className="mt-8 space-y-4 flex-1">
                          <div className="flex justify-between items-center text-xs">
                             <span className="font-bold text-gray-400 uppercase">Saldo Pendiente</span>
                             <span className="font-black text-rose-500 text-lg">{formatearPrecio(item.saldoPendiente)}</span>
                          </div>
              ...
              {filtrados.length === 0 && (
                 <div className="col-span-full py-20 text-center">
                    <p className="text-gray-400 font-bold uppercase tracking-widest text-sm">No se encontraron resultados</p>
                 </div>
              )}
           </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
           <div className="flex items-center gap-6">
              ...
              <div>
                 <div className="flex items-center gap-3 mb-1">
                    <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Expediente Individual</span>
                 ...
                 <h1 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight">Crédito #{credito.idCredito}</h1>
              </div>
           </div>
           ...
           {credito.estado === 'activo' && (
             <button 
                ...
                className="flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-indigo-600 to-blue-600 text-white font-black uppercase text-xs tracking-widest rounded-[2rem] shadow-xl shadow-indigo-500/40 hover:scale-105 active:scale-95 transition-all"
             >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 ...
                 <div className="bg-white dark:bg-gray-900 p-8 rounded-[3rem] shadow-xl shadow-gray-200/40 dark:shadow-none border border-gray-100 dark:border-gray-800 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                       <p className="text-2xl font-black text-gray-900 dark:text-white leading-tight">{credito.usuarioCliente?.nombres} {credito.usuarioCliente?.apellidos}</p>
                       <p className="text-xs text-indigo-500 font-bold mb-8">{credito.usuarioCliente?.correoElectronico || 'Correo no registrado'}</p>
                        ...
                        <div className="space-y-4">
                           <div className="flex justify-between items-center bg-gray-50 dark:bg-gray-800/50 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 transition-all hover:bg-white dark:hover:bg-gray-800 hover:shadow-md">
                              <p className="text-[10px] font-black text-gray-400 uppercase tracking-wider">Documento</p>
                              <p className="text-sm font-black text-gray-700 dark:text-gray-200">{credito.usuarioCliente?.usuario || 'N/A'}</p>
                           </div>
                           <div className="flex justify-between items-center bg-gray-50 dark:bg-gray-800/50 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 transition-all hover:bg-white dark:hover:bg-gray-800 hover:shadow-md">
                              <p className="text-[10px] font-black text-gray-400 uppercase tracking-wider">Teléfono</p>
                              <p className="text-sm font-black text-gray-700 dark:text-gray-200">{credito.usuarioCliente?.telefono || 'N/A'}</p>
                           </div>
                        </div>
                    </div>
                 </div>
                 ...
                 <div className="bg-white dark:bg-gray-900 p-8 rounded-[3rem] shadow-xl shadow-gray-200/40 dark:shadow-none border border-gray-100 dark:border-gray-800 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                       <p className="text-2xl font-black text-gray-900 dark:text-white">Venta #{credito.venta?.numeroFactura}</p>
                       <p className="text-xs text-gray-500 font-bold mb-8 uppercase tracking-tighter">Emitida el {new Date(credito.venta?.creadoEn).toLocaleDateString()}</p>
                       
                       <div className="grid grid-cols-2 gap-4">
                          <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-2xl border border-gray-100 dark:border-gray-800">
                             <p className="text-[9px] font-black text-gray-400 uppercase leading-none mb-1">Valor Venta</p>
                             <p className="text-sm font-black text-gray-700 dark:text-gray-200">{formatearPrecio(credito.venta?.total)}</p>
                          </div>
                          <div className="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-2xl border border-indigo-100 dark:border-indigo-900/30">
                             <p className="text-[9px] font-black text-indigo-400 uppercase leading-none mb-1">Monto de Deuda</p>
                             <p className="text-sm font-black text-indigo-600 dark:text-indigo-400">{formatearPrecio(credito.montoTotal)}</p>
                          </div>
                       </div>

                       <button
                          onClick={() => navigate(`/admin/ventas/detalle/${credito.idVenta}`)}
                          className="mt-6 w-full flex items-center justify-center gap-3 px-6 py-4 bg-gray-900 dark:bg-gray-800 text-white font-black text-[10px] uppercase tracking-widest rounded-2xl shadow-xl transition-all hover:scale-105 active:scale-95"
                       >
                        ...
                        return (
                           <div key={item.idDetalleVenta} className="flex gap-6 p-5 rounded-[2.5rem] bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:border-indigo-100 dark:hover:border-indigo-900/40 transition-all items-center group">
                              ...
                              <div className="flex-1 min-w-0">
                                 <p className="font-black text-gray-900 dark:text-white text-base leading-tight truncate uppercase tracking-tight">{item.variante?.producto?.nombreProducto}</p>
                                 <div className="flex flex-wrap gap-2 mt-3">
                                    <span className="text-[9px] font-black bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-xl text-gray-500 dark:text-gray-400 uppercase tracking-widest">
                                 ...
                                 <p className="text-[9px] font-bold text-gray-400 mt-3 tracking-[0.2em] uppercase">SKU: {item.variante?.codigoSku}</p>
                              </div>
                              <div className="text-right">
                                 <p className="text-[11px] font-black text-gray-400 uppercase mb-1">Cant. x{Number(item.cantidad)}</p>
                                 <p className="text-xl font-black text-gray-900 dark:text-white tracking-tighter">{formatearPrecio(item.totalLinea || item.subtotal)}</p>
                              </div>
                           </div>
                        )
                     })}
           ...
           <div className="space-y-8">
              ...
              <div className="bg-white dark:bg-gray-900 p-10 rounded-[4rem] shadow-2xl shadow-indigo-500/10 dark:shadow-none border border-gray-100 dark:border-gray-800 text-center relative overflow-hidden group">
                 ...
                 <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] mb-4">Saldo Pendiente Actual</p>
                 <p className="text-5xl font-black text-gray-900 dark:text-white mb-10 tracking-tighter">{formatearPrecio(credito.saldoPendiente)}</p>
                 ...
                 <div className="flex justify-between items-end border-t border-gray-100 dark:border-gray-800 pt-8">
                    <div className="text-left space-y-1">
                       <p className="uppercase text-[9px] font-black text-gray-400 tracking-widest">Total Crédito</p>
                       <p className="text-lg font-black text-gray-900 dark:text-white">{formatearPrecio(credito.montoTotal)}</p>
                    </div>
                    <div className="text-right space-y-1">
                       <p className="uppercase text-[9px] font-black text-emerald-500 tracking-widest">Abonado ({100 - calculateDebtPercentage()}%)</p>
                       <p className="text-2xl font-black text-emerald-600">{formatearPrecio(credito.totalAbonado)}</p>
                    </div>
                 </div>
              </div>
                 ...
                 <div className="flex-1 overflow-y-auto custom-scrollbar space-y-6 pr-4 relative">
                    {credito.venta?.pagos?.filter(p => p.tipoPago === 'abono' || p.metodoPago?.nombreMetodo.toLowerCase().includes('crédito') === false).map((pago, idx) => (
                       <div key={pago.idPago} className="relative pl-10 group">
                          ...
                          <div className="absolute left-0 top-1 h-6 w-6 rounded-2xl bg-white dark:bg-gray-900 border-2 border-indigo-500 flex items-center justify-center text-[10px] font-black text-indigo-500 z-10 transition-all group-hover:scale-110 group-hover:bg-indigo-500 group-hover:text-white">
                             {idx + 1}
                          </div>
                          ...
                          <div className="bg-gray-50 dark:bg-gray-800/40 p-5 rounded-[2rem] border border-gray-100 dark:border-gray-800 transition-all hover:bg-white dark:hover:bg-gray-900 hover:shadow-xl hover:border-indigo-100 dark:hover:border-indigo-900/40">
                             <div className="flex justify-between items-start">
                                <div>
                                   <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">{pago.metodoPago?.nombreMetodo}</p>
                                   <p className="text-sm font-black text-gray-700 dark:text-gray-200">{new Date(pago.fechaPago).toLocaleDateString()}</p>
                                </div>
                                <span className="text-lg font-black text-emerald-600">+{formatearPrecio(pago.monto)}</span>
                             </div>
                             {pago.referencia && (
                                <p className="mt-3 text-[9px] font-black text-indigo-400 uppercase tracking-tighter bg-indigo-50 dark:bg-indigo-900/20 px-2 py-1 rounded-lg inline-block">Ref: {pago.referencia}</p>
                             )}
                          </div>
                       </div>
                    ))}
                    {(!credito.venta?.pagos || credito.venta?.pagos.length === 0) && (
                       <div className="text-center py-20 space-y-4">
                          ...
                          <p className="text-xs font-black text-gray-400 uppercase tracking-widest italic leading-relaxed">
