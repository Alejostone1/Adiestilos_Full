      ...
      <div className="card-3d card-elevated bg-white dark:bg-slate-800/60 rounded-3xl overflow-hidden">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-50/50 dark:bg-slate-800/30 text-left">
                <th className="px-6 py-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-slate-700/50">Identidad</th>
                <th className="px-6 py-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-slate-700/50">Contacto</th>
                <th className="px-6 py-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-slate-700/50">Rol y Perfil</th>
                <th className="px-6 py-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-slate-700/50">Actividad</th>
                <th className="px-6 py-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-slate-700/50">Estado</th>
                <th className="px-6 py-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-right border-b border-gray-100 dark:border-slate-700/50">Acciones</th>
              </tr>
            </thead>
                      ...
                      <td className="px-6 py-5">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            <span className={`text-xs font-semibold mt-1 ${u.resumenCredito?.saldoTotal > 0 ? 'text-amber-600' : 'text-gray-400'}`}>
        ...
        <div className="p-6 bg-gray-50/50 dark:bg-slate-800/30 border-t border-gray-100 dark:border-slate-700/50 flex justify-between items-center">
            ...
            <div className="flex gap-2">
              ...
              <button disabled className="card-3d px-4 py-2 bg-white dark:bg-slate-800/40 rounded-xl text-sm font-semibold text-gray-400 dark:text-gray-600 disabled:cursor-not-allowed">Siguiente</button>
            </div>
        </div>
      </div>
              ...
              <form onSubmit={handleSave} className="p-8 space-y-8 flex-1">
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                       <label className="text-sm font-semibold text-gray-700 dark:text-gray-300 ml-1">Apellidos</label>
                       <input 
                        required
                        type="text" 
                        className="card-3d w-full px-4 py-3 bg-gray-50 dark:bg-slate-700/40 border-0 rounded-2xl focus:ring-4 focus:ring-indigo-50 dark:focus:ring-indigo-900/30 focus:border-indigo-500 dark:text-white transition-all"
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-gray-700 dark:text-gray-300 ml-1">Dirección de Domicilio</label>
                ...
                <div className="space-y-6">
                  ...
                  {!isEditing && (
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-gray-700 dark:text-gray-300 ml-1 text-red-500">Contraseña de Seguridad</label>
                      <input 
                        required
                        type="password" 
                      ...
                      />
                      <p className="text-[11px] text-gray-400 dark:text-gray-500 italic font-medium ml-2">El usuario podrá cambiarla después de su primer ingreso.</p>
                    </div>
                  )}
                </div>
                ...
                <div className="pt-8 flex gap-4">
                  <button 
                    ...
                    className="card-3d flex-1 py-4 px-6 bg-gray-100 dark:bg-slate-700/40 text-gray-600 dark:text-gray-300 rounded-2xl font-semibold hover:bg-gray-200 dark:hover:bg-slate-600/60 transition-all"
                  >
                    Descartar
                  </button>
                  <button 
